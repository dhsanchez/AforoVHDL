...
set_property used_in_implementation false [get_files C:/Users/dsanc/TresEnRaya/Nexys-4-DDR-Master.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top controlaforo -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef controlaforo.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file controlaforo_utilization_synth.rpt -pb controlaforo_utilization_synth.pb"
